// Test file to generate fake bugs for each database to verify bug logging works
...
public class TestBugLogging {
    ...
    public static void main(String[] args) {
        ...
        // Test 1: OrderDatabase - Simulated SQL exception
        testOrderDatabaseBug();
        
        // Test 2: DriverDatabase - Simulated null pointer
        testDriverDatabaseBug();
        
        // Test 3: PaymentDatabase - Simulated invalid payment
        testPaymentDatabaseBug();
        
        // Test 4: UserDatabase - Simulated authentication failure
        testUserDatabaseBug();
        
        // Test 5: UI Components - Simulated UI exception
        testUIComponentBug();
        
        // Test 6: Manual bug report with all fields
        testManualBugReport();
